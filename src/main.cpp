...
uint256 hashGenesisBlock("0x8e41f862a0253b58700f7f4ab3427a839313bcab95c6c06c95e29c53f179127e");
...
const string strMessageMagic = "bigpicoin Signed Message:\n";
...
static const int64 nTargetTimespan = 5.23 * 60; // bigpicoin: 10 blocks
static const int64 nTargetSpacing = 31.4; // bigpicoin: 30 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bigpicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bigpicoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x347dd947c76ef378595b2932ac77fa5ec8f7116049340938bd21342b67aa1171"));
